...
@Component({
  selector: 'FamilyMember-home',
  templateUrl: './FamilyMember-home.component.html',
  styleUrls: ['./FamilyMember-home.component.scss']
})
export class FamilyMemberHomeComponent implements AfterViewInit {
