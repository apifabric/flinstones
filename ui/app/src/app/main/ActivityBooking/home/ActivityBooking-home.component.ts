...
@Component({
  selector: 'ActivityBooking-home',
  templateUrl: './ActivityBooking-home.component.html',
  styleUrls: ['./ActivityBooking-home.component.scss']
})
export class ActivityBookingHomeComponent implements AfterViewInit {
