...
@Component({
  selector: 'PackageBooking-home',
  templateUrl: './PackageBooking-home.component.html',
  styleUrls: ['./PackageBooking-home.component.scss']
})
export class PackageBookingHomeComponent implements AfterViewInit {
