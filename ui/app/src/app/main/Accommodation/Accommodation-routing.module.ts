...
const routes: Routes = [
  ...
  { path: ':id', component: AccommodationDetailComponent,
    ...
    path: ':accommodation_id/Booking', loadChildren: () => import('../Booking/Booking.module').then(m => m.BookingModule),
    data: {
        oPermission: {
    ...
    path: ':accommodation_id/Review', loadChildren: () => import('../Review/Review.module').then(m => m.ReviewModule),
    data: {
        oPermission: {
